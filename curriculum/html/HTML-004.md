...
Complete a reviewable engineering exercise that demonstrates **build an accessible form** and explain the decisions you made.

## Context

This is task 4 in the HTML phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind build an accessible form.
...
1. Create or update the task artifact under `projects/beginner/site/html-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates build an accessible form.
...
- Primary workspace: `projects/beginner/site/html-004/`
- Evidence: `projects/beginner/site/html-004/README.md`
...
- [ ] The artifact directly demonstrates build an accessible form.
...
From the repository root, enter `projects/beginner/site/html-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[HTML-004]`.
...
`task/<github-username>/html-004-build-an-accessible-form`

## Commit Message

`build: complete html-004 build an accessible form`
