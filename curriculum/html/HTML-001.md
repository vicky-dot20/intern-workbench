...
Complete a reviewable engineering exercise that demonstrates **create a semantic html document** and explain the decisions you made.

## Context

This is task 1 in the HTML phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind create a semantic html document.
...
1. Create or update the task artifact under `projects/beginner/site/html-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates create a semantic html document.
...
- Primary workspace: `projects/beginner/site/html-001/`
- Evidence: `projects/beginner/site/html-001/README.md`
...
- [ ] The artifact directly demonstrates create a semantic html document.
...
From the repository root, enter `projects/beginner/site/html-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[HTML-001]`.
...
`task/<github-username>/html-001-create-a-semantic-html-document`

## Commit Message

`build: complete html-001 create a semantic html document`
