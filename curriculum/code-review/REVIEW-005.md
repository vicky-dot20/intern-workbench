...
Complete a reviewable engineering exercise that demonstrates **write useful, respectful review comments** and explain the decisions you made.

## Context

This is task 5 in the Code Review phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind write useful, respectful review comments.
...
1. Create or update the task artifact under `projects/advanced/review-fixtures/review-005/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates write useful, respectful review comments.
...
- Primary workspace: `projects/advanced/review-fixtures/review-005/`
- Evidence: `projects/advanced/review-fixtures/review-005/README.md`
...
- [ ] The artifact directly demonstrates write useful, respectful review comments.
...
From the repository root, enter `projects/advanced/review-fixtures/review-005` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[REVIEW-005]`.
...
`review: complete review-005 write useful, respectful review comments`
