...
Complete a reviewable engineering exercise that demonstrates **reproduce and isolate a frontend bug** and explain the decisions you made.

## Context

This is task 4 in the Debugging phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind reproduce and isolate a frontend bug.
...
1. Create or update the task artifact under `projects/advanced/incident-lab/debug-004/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates reproduce and isolate a frontend bug.
...
- Primary workspace: `projects/advanced/incident-lab/debug-004/`
- Evidence: `projects/advanced/incident-lab/debug-004/README.md`
...
- [ ] The artifact directly demonstrates reproduce and isolate a frontend bug.
...
From the repository root, enter `projects/advanced/incident-lab/debug-004` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[DEBUG-004]`.
...
`debug: complete debug-004 reproduce and isolate a frontend bug`
