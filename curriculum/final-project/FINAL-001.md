...
Complete a reviewable engineering exercise that demonstrates **select the product and clarify requirements** and explain the decisions you made.

## Context

This is task 1 in the Final Project phase. It builds one durable skill inside the same GitHub workflow used for product work: issue, branch, implementation, validation, pull request, review, and revision.

## What You Need to Learn

- The core concepts behind select the product and clarify requirements.
...
1. Create or update the task artifact under `projects/final/final-001/`; do not scatter unrelated changes across the repository.
2. Add a short `README.md` in that task artifact containing the problem, your plan, commands used, and result.
3. Produce the smallest working example or analysis that demonstrates select the product and clarify requirements.
...
- Primary workspace: `projects/final/final-001/`
- Evidence: `projects/final/final-001/README.md`
...
- [ ] The artifact directly demonstrates select the product and clarify requirements.
...
From the repository root, enter `projects/final/final-001` and follow its README. If the task is documentation or investigation only, render/preview the Markdown and run the repository validation command instead.
...
1. Confirm the assigned issue title starts with `[FINAL-001]`.
...
`task/<github-username>/final-001-select-the-product-and-clarify-requirement`

## Commit Message

`project: complete final-001 select the product and clarify requirements`
